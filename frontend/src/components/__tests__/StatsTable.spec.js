...
describe('StatsTable', () => {
    ...
    it('it renders data properly', () => {
        ...
        expect(wrapper.text()).toBe("SymbolCumulative returnAnnualized comulative returnAnnualized volatilityTEST101520ABCD905523Showing 1-2 of 2Row count:102550Go to page:1«First<Prev1>Next»Last")
    })
